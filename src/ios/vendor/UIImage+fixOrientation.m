...
- (UIImage *)fixOrientation {
    ...
    switch (self.imageOrientation) {
        ...
        case UIImageOrientationDownMirrored:
            ...
            cropRect = CGRectMake( self.size.width*0.39, self.size.height*0.39, self.size.width*0.78, 0.78*self.size.height);
            break;

        case UIImageOrientationLeft:
        case UIImageOrientationLeftMirrored:
            //phone top down selfie portrait
            cropRect = CGRectMake( self.size.height*0.39, self.size.width*0.39, self.size.height*0.78, self.size.width*0.78);
            break;
        ...
        case UIImageOrientationUpMirrored:
            ...
            cropRect = CGRectMake( self.size.width*0.39, self.size.height*0.39, self.size.width*0.78, self.size.height*0.78);
