...
- (UIImage *)fixOrientation {
    ...
    switch (self.imageOrientation) {
        ...
        case UIImageOrientationDownMirrored:
            ...
            cropRect = CGRectMake( self.size.width*0.095, self.size.height*0.095, self.size.width*0.77, 0.77*self.size.height);
            break;

        case UIImageOrientationLeft:
        case UIImageOrientationLeftMirrored:
            //phone top down selfie portrait
            cropRect = CGRectMake( self.size.height*0.095, self.size.width*0.095, self.size.height*0.77, self.size.width*0.77);
            break;
        ...
        case UIImageOrientationUpMirrored:
            ...
            cropRect = CGRectMake( self.size.width*0.095, self.size.height*0.095, self.size.width*0.77, self.size.height*0.77);
